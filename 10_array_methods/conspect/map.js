// Метод map()экземпляров Arrayсоздает новый массив, заполняемый результатами вызова предоставленной функции для каждого элемента вызывающего массива.
// Метод map()является итеративным . Он вызывает предоставленную callbackFnфункцию один раз для каждого элемента массива и на основе результатов
